...
<form class="tutor-course-filter-form tutor-form">
	...
	<?php if ( in_array( 'search', $supported_filters ) ) : ?>
		<div class="tutor-widget tutor-widget-search av-widget">
	...
	<?php if ( in_array( 'category', $supported_filters ) ) : ?>
		<div class="tutor-widget tutor-widget-course-categories tutor-mt-48  av-widget">
	...
	<?php if ( in_array( 'tag', $supported_filters ) ) : ?>
		<div class="tutor-widget tutor-widget-course-tags tutor-mt-48  av-widget">
			<h3 class="tutor-widget-title">
	...
	<?php if ( in_array( 'difficulty_level', $supported_filters ) ) : ?>
		<div class="tutor-widget tutor-widget-course-levels tutor-mt-48  av-widget">
			<h3 class="tutor-widget-title">
	...
	?>
	<div class="tutor-widget tutor-widget-course-price tutor-mt-48  av-widget">
		<h3 class="tutor-widget-title">
			<?php _e( 'Price', 'tutor' ); ?>
		</h3>
