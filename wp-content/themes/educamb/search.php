...
get_header();
global $wp_query;
$data  = \EDUCAMB\Includes\Classes\Common::instance()->data( 'search' )->get();
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="blog-sidebar default-sidebar">
                                    <p class="mb-4"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'educamb' ); ?></p>
