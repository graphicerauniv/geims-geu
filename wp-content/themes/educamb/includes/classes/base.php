...
use EDUCAMB\Includes\Classes\Header_Enqueue;
use EDUCAMB\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['educamb_base'] ) ) {
			return $GLOBALS['educamb_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( 'educamb' . '_options-mods' );

		$dn = educamb_dot( $options );
