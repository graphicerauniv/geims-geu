...
class Options {
	 ...
	 * @var string
	 */
	private $opt_name = 'educamb' . '_options';
	...
	private $page_slug = 'educamb' . '_options';
	...
	function init() {
		...
		$this->menu_title = esc_html__( 'EDUCAMB Options', 'educamb' );
		$this->page_title = esc_html__( 'EDUCAMB Options', 'educamb' );
	...
	function args() {
		...
		$args = array(
			...
			'global_variable'      => 'educamb_options',
	...
	function helpTabs() {
		...
		$tabs = array(
			array(
				'id'      => 'redux-help-tab-1',
				'title'   => esc_html__( 'Theme Information 1', 'educamb' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'educamb' ),
			),
			array(
				'id'      => 'redux-help-tab-2',
				'title'   => esc_html__( 'Theme Information 2', 'educamb' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'educamb' ),
			),
		);
		...
		$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'educamb' ) . '</p>';
	...
	function sections() {
		...
		$sections_path = apply_filters( 'educamb_redux_sections', $sections_path );
		...
		foreach ( $sections_path as $key => $file ) {
			...
			if ( file_exists( $file ) ) {
				...
				$options = apply_filters( "educamb_redux_sections_{$key}", $options );
