 ...
 */
//educamb_load_default_hooks
function educamb_load_default_hooks() {

	$config = educamb_WSH()->config( 'default' );
...
/**
 * [educamb_main_header_area description]
 *
 * @return [type] [description]
 */

//educamb_main_header_area
function educamb_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		educamb_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		educamb_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		educamb_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		educamb_template_load( 'templates/header/header_v4.php' );
	} elseif ( $header == 'header_v5' ) {
		educamb_template_load( 'templates/header/header_v5.php' );
	} elseif ( $header == 'header_v6' ) {
		educamb_template_load( 'templates/header/header_v6.php' );
	} elseif ( $header == 'header_v7' ) {
		educamb_template_load( 'templates/header/header_v7.php' );
	} elseif ( $header == 'header_v8' ) {
		educamb_template_load( 'templates/header/header_v8.php' );
	} elseif ( $header == 'header_v9' ) {
		educamb_template_load( 'templates/header/header_v9.php' );
	} elseif ( $header == 'header_v10' ) {
		educamb_template_load( 'templates/header/header_v10.php' );
	} else {
		educamb_template_load( 'templates/header/default-header.php' );
	}
}
...
/**
 * [educamb_main_footer_area description]
 *
 * @return [type] [description]
 */
//educamb_main_footer_area
function educamb_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		educamb_template_load( 'templates/footer/default-footer.php' );
	} elseif ( $footer == 'footer_v2' ) {
		educamb_template_load( 'templates/footer/footer_v2.php' );
	} elseif ( $footer == 'footer_v3' ) {
		educamb_template_load( 'templates/footer/footer_v3.php' );
	} elseif ( $footer == 'footer_v4' ) {
		educamb_template_load( 'templates/footer/footer_v4.php' );
	} elseif ( $footer == 'footer_v5' ) {
		educamb_template_load( 'templates/footer/footer_v5.php' );
	} elseif ( $footer == 'footer_v6' ) {
		educamb_template_load( 'templates/footer/footer_v6.php' );
	} elseif ( $footer == 'footer_v7' ) {
		educamb_template_load( 'templates/footer/footer_v7.php' );
	} elseif ( $footer == 'footer_v8' ) {
		educamb_template_load( 'templates/footer/footer_v8.php' );
	} elseif ( $footer == 'footer_v9' ) {
		educamb_template_load( 'templates/footer/footer_v9.php' );
	} elseif ( $footer == 'footer_v10' ) {
		educamb_template_load( 'templates/footer/footer_v10.php' );
	} else {
		educamb_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [educamb_sidebar description]
 *
 * @return [type] [description]
 */
//educamb_sidebar
function educamb_sidebar( $data ) {

	educamb_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [educamb_banner description]
 *
 * @return [type] [description]
 */
//educamb_banner
function educamb_banner( $data ) {

	educamb_template_load( 'templates/banner/banner.php', compact( 'data' ) );
