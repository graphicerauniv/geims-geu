...
//Home Four Logo Settings
$home_four_logo = $options->get( 'home_four_logo' );
$home_four_logo_dimension = $options->get( 'home_four_logo_dimension' );
...
//Author Icon Image
$author_img = $options->get( 'author_logo' );
$author_img = educamb_set( $author_img, 'url', EDUCAMB_URI . 'assets/images/instructor/header-style4-user-1.jpg' );
                ...
                <div class="outer-box">
                    ...
                    <div class="header-style4__left">
                        <div class="logo-box-style4">
                            <?php echo educamb_logo( $logo_type, $home_four_logo, $home_four_logo_dimension, $logo_text, $logo_typography ); ?>
                        </div>
                    </div>
                    <!--End Header Left-->
                    ...
                    <div class="header-style4__right">
                        <div class="header-style4__user-cart-box">
                            <ul class="clearfix">
                                <?php if($options->get('author_img_link_v4')) {?>
                                <li>
                                    <div class="user-box-style1">
                                        <a href="<?php echo esc_url($options->get('author_img_link_v4')); ?>">
                                            <img src="<?php echo esc_url($author_img); ?>" alt="<?php esc_attr_e('Awesome Image', 'educamb'); ?>">
                                        </a>
                                    </div>
                                </li>
                                <?php } ?>
                        ...
                        <div class="header-categories-box-style1">
                            <div class="icon">
