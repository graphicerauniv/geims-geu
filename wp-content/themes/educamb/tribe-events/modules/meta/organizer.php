	...
	<ul class="list">
		...
		foreach ( $organizer_ids as $organizer ) {
			...
			<span class="tribe-organizer">
				<?php esc_html_e('Name: ', 'educamb'); echo tribe_get_organizer_link( $organizer ) ?>
			</span>
			</li>
			<?php
		}
		...
		if ( ! $multiple ) { // only show organizer details if there is one
			...
			if ( ! empty( $website ) ) {
				...
				<li><span class="icon flaticon-internet"></span>
					<?php esc_html_e( 'Website: ', 'educamb' ) ?>
				<span class="tribe-organizer-url">
					<?php echo wp_kses($website, true); ?>
				</span>
				</li>
				<?php
			}//end if
