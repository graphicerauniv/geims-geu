 ...
 * @var int Event post id
 */
$time_title = apply_filters( 'tribe_events_single_event_time_title', esc_html__( 'Time:', 'educamb' ), $event_id );
...
<div class="tribe-events-meta-group tribe-events-meta-group-details info-block">
	<h3 class="tribe-events-single-section-title"> <?php esc_html_e( 'Event Details', 'educamb' ) ?> </h3>
	<ul class="list">
		...
		if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
			...
			<li><span class="icon flaticon-time"></span> <?php esc_html_e( 'Start:', 'educamb' ) ?>
			...
			<li><span class="icon flaticon-time"></span> <?php esc_html_e( 'End:', 'educamb' ) ?>
		...
		elseif ( tribe_event_is_all_day() ):
			...
			<li> <span class="icon flaticon-time"></span> <?php esc_html_e( 'Date:', 'educamb' ) ?>
				<abbr class="tribe-events-abbr tribe-events-start-datetime published dtstart" title="<?php esc_attr( $start_ts ) ?>"> <?php echo wp_kses( $start_date, true ) ?> </abbr>
			</li>
		...
		// Single day events
			...
			<li> <span class="icon fa fa-calendar"></span> <?php esc_html_e( 'Date:', 'educamb' ) ?>
		...
		if ( ! empty( $cost ) ) : ?>
			...
			<li> <?php esc_html_e( 'Cost:', 'educamb' ) ?>
		...
		<?php echo tribe_meta_event_tags( sprintf( esc_html__( '%s Tags:', 'educamb' ), tribe_get_event_label_singular() ), ', ', false ) ?>

		<?php
		// Event Website
		if ( ! empty( $website ) ) : ?>

			<li> <?php esc_html_e( 'Website:', 'educamb' ) ?> 
