		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">December 01, 2023 <span class="changelog-version">Lite Version 5.2.21</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Fix : Admin Panel Minor bug fixes and Improvements', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Blog Listout : Condition Improvements', 'tpebl').'</li>';
						echo '</ul>';
				echo '</div>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">November 06, 2023 <span class="changelog-version">Pro Version 5.2.19</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Add : Gallery Listing : Border Radius on hover of feature Image', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Improvment : Number Counter : Icon Style Condition Improvement', 'tpebl').'</li>';
