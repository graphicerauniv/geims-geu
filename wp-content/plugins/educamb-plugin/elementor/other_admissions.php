 ...
 * @since 1.0.0
 */
class Other_Admissions extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_other_admissions';
    }
    ...
    public function get_title() {
        return esc_html__( 'Other Admissions', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'other_admissions',
            [
                'label' => esc_html__( 'Other Admissions', 'educamb' ),
            ]
        );
		$this->add_control(
			'title',
