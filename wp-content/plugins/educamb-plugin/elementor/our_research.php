 ...
 * @since 1.0.0
 */
class Our_Research extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Research', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_research',
			[
				'label' => esc_html__( 'Our Research', 'educamb' ),
			]
		);
		$this->add_control(
			'title',
                    ...
                    <div class="theme_carousel research-carousel owl-theme owl-carousel owl-dot-style1"
                        ...
                        <div class="single-research-box">
                            <div class="img-holder">
                                <?php the_post_thumbnail('educamb_550x320'); ?>
                                <div class="icon">
