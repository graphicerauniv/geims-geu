...
class Banner_V2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Banner V2', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'banner_v2',
            [
                'label' => esc_html__( 'Banner V2', 'educamb' ),
            ]
        );
		$this->add_control(
            'slides', 
    ...
    <!-- Start Main Slider -->
    <section class="main-slider style2 nav-style2">
        <div class="slider-box">
            ...
            <div class="banner-carousel owl-theme owl-carousel">
                ...
                <!-- Slide -->
                <div class="<?php if($item['style_two'] == 'two') echo 'slide right'; else echo 'slide'; ?>">
