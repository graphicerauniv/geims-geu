 ...
 * @since 1.0.0
 */
class Our_Events_V2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Our Events V2', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'our_events_v2',
            [
                'label' => esc_html__( 'Our Events V2', 'educamb' ),
			]
        );
		$this->add_control(
			'pattern_image',
    ...
    <!--Start Events Style2 Area-->
    <section class="event-style2-area">
        <div class="event-style2-area__bg" <?php if($settings['pattern_image']['id']) { ?>
            style="background-image: url(<?php echo esc_url(wp_get_attachment_url($settings['pattern_image']['id'])); ?>);"<?php } ?>></div>
        <div class="event-style2-area-shape" <?php if($settings['pattern_image2']['id']) { ?> style="background-image: url(<?php echo esc_url(wp_get_attachment_url($settings['pattern_image2']['id'])); ?>);"<?php } ?>>
        </div>
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-8">
                    <div class="event-style2__content">
                        ...
                        <div class="event-style2-carousel owl-theme owl-carousel owl-nav-style-one">
                            <?php 
								global $post;
								if ( empty( $events ) ) :
