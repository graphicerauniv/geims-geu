...
class Latest_News_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News V2', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'latest_news_v2',
			[
				'label' => esc_html__( 'Latest News V2', 'educamb' ),
			]
		);
		$this->add_control(
			'style_two',
    ...
    <section class="<?php if($settings['style_two'] == 'two') echo 'blog-style2-area kindergarten-blog-page-one'; else echo 'blog-style2-area'; ?>">
        <div class="container">
                    ...
                    <div class="single-blog-style3">
                        <div class="img-holder">
                            <div class="inner">
								...
								<?php the_post_thumbnail('educamb_340x260'); ?>
                        ...
                        <div class="text-holder">
                            ...
                            <div class="meta-info">
                                <ul>
                                    ...
                                    <li>
                                        <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta('ID') )); ?>"><?php esc_html_e('By', 'educamb'); ?> <?php the_author(); ?></a>
                                    </li>
                                </ul>
                            </div>
