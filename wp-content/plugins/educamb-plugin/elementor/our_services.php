...
class Our_Services extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Services', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_services',
			[
				'label' => esc_html__( 'Our Services', 'educamb' ),
			]
		);
		$this->add_control(
			'style_two',
	...
	protected function render() {
       ...
       <!-- service-section -->
        <section class="service-section <?php if($settings['style_two'] == 'three') echo 'pb-215 sec-pad'; elseif($settings['style_two'] == 'two') echo 'service-page bg-color-1'; else echo ''; ?>" id="services" >
            <div class="auto-container">
                ...
                <?php } ?>
                <div class="inner-content <?php if($settings['style_two'] == 'three') echo 'mr-0'; elseif($settings['style_two'] == 'two') echo ''; else echo ''; ?>">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                            <div class="service-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    <figure class="image-box"><a href="<?php echo esc_url(get_post_meta( get_the_id(), 'service_url', true ));?>"><?php the_post_thumbnail('educamb_370x400'); ?></a></figure>
                                    <div class="lower-content">
                                        <div class="inner">
                                            <div class="light-icon"><i class="<?php echo wp_kses(str_replace( "icon ",  "", get_post_meta(get_the_id(), 'service_icon', true )), true); ?>"></i></div>
