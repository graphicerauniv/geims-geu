 ...
 * @since 1.0.0
 */
class Our_Feature_V4 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Our Feature V4', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'our_feature_v4',
            [
                'label' => esc_html__( 'Our Feature V4', 'educamb' ),
            ]
        );
		$this->add_control(
           'features', 
    ...
    <section class="features-style4-area">
        <div class="auto-container">
            <ul class="row">
                ...
                <li class="col-xl-3 col-lg-6 col-md-6 single-features-style4">
                    <div class="single-features-style4__inner">
                        <?php if($item['icons']) {?>
                        <div class="icon">
                            <div class="icon-bg"
