 ...
 * @since 1.0.0
 */
class Styles_Of_Photography extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_styles_of_photography';
    }
    ...
    public function get_title() {
        return esc_html__( 'Styles Of Photography', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'styles_of_photography',
            [
                'label' => esc_html__( 'Styles Of Photography', 'educamb' ),
            ]
        );
		$this->add_control(
			'subtitle',
    ...
    <section class="choose-style1-area photography-choose-area">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="single-choose-style1 photography-single-choose-box">
