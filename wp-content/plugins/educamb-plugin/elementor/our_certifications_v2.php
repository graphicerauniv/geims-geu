 ...
 * @since 1.0.0
 */
class Our_Certifications_V2 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_our_certifications_v2';
    }
    ...
    public function get_title() {
        return esc_html__( 'Our Certifications V2', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'our_certifications_v2',
            [
                'label' => esc_html__( 'Our Certifications V2', 'educamb' ),
            ]
        );
		$this->add_control(
			'style_two',
    ...
    <section class="<?php if($settings['style_two'] == 'two') echo 'certifications-area certifications-area--style3'; else echo 'certifications-area certifications-area--style2'; ?>">
        <div class="container">
