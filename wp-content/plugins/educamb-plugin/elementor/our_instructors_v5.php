 ...
 * @since 1.0.0
 */
class Our_Instructors_V5 extends Widget_Base {
	/**
	 * Get widget name.
	...
	public function get_name() {
		return 'educamb_our_instructors_v5';
	}
	/**
	 * Get widget title.
	...
	public function get_title() {
		return esc_html__( 'Our Instructors V5', 'educamb' );
	}
	/**
	 * Get widget icon.
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_instructors_v5',
			[
				'label' => esc_html__( 'Our Instructors V5', 'educamb' ),
			]
		);
		$this->add_control(
			'sub_title',
    ...
    <section class="instructors-area">
        <div class="container">
