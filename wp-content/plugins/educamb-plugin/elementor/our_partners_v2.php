 ...
 * @since 1.0.0
 */
class Our_Partners_V2 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_our_partners_v2';
    }
    ...
    public function get_title() {
        return esc_html__( 'Our Partners V2', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'our_partners_v2',
            [
                'label' => esc_html__( 'Our Partners V2', 'educamb' ),
            ]
        );
		$this->add_control(
			'title',
    ...
    <section class="partner-style2-area">
        <div class="container">
            ...
            <div class="sec-title-style3 text-center">
                ...
                <?php } ?>
                <?php if($settings['text']) { ?><h2><?php echo wp_kses($settings['text'], true);?></h2><?php } ?>
            </div>
			<?php } ?>
            <div class="row">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="partner-style2-bottom-text">
