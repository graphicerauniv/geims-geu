 ...
 * @since 1.0.0
 */
class Need_Help_V2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Need Help V2', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'need_help_v2',
            [
                'label' => esc_html__( 'Need Help V2', 'educamb' ),
            ]
        ); 
		$this->add_control(
		  'feature', 
    ...
    <section class="academy-slogan-area marketplace-slogan-area gray-bg">
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="<?php if($item['style_two'] == 'two') echo 'academy-slogan-content-one academy-slogan-content-one--style2'; else echo 'academy-slogan-content-one'; ?>">
                        <div class="marketplace-slogan-content-one__bg"
