 ...
 * @since 1.0.0
 */
class Subscribe_Us extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Subscribe Us', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'subscribe_us',
            [
                'label' => esc_html__( 'Subscribe Us', 'educamb' ),
            ]
        );
		$this->add_control(
			'feature_image',
