...
class Call_To_Action extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Call To Action', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'call_to_action',
            [
                'label' => esc_html__( 'Call To Action', 'educamb' ),
            ]
        );
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			'bg_image2',
			[
				'label' => esc_html__('BG Image Two', 'educamb'),
				'type' => Controls_Manager::MEDIA,
				'default' => ['url' => Utils::get_placeholder_image_src(),],
			]
		);
    ...
    <section class="<?php if($settings['style_two'] == 'two') echo 'slogan-style1-area slogan-style1-area--style2'; else echo 'slogan-style1-area'; ?>">
