 ...
 * @since 1.0.0
 */
class Our_Partners_V5 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_our_partners_v5';
    }
    ...
    public function get_title() {
        return esc_html__( 'Our Partners V5', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'our_partners_v5',
            [
                'label' => esc_html__( 'Our Partners V5', 'educamb' ),
            ]
        );
		$this->add_control(
			'sub_title',
    ...
    <!--Start Partner Style5 Area-->
    <section class="partner-style5-area">
        <div class="container">
