 ...
 * @since 1.0.0
 */
class Video_Section_V3 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_video_section_v3';
    }
    ...
    public function get_title() {
        return esc_html__( 'Video Section V3', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'video_section_v3',
            [
                'label' => esc_html__( 'Video Section V3', 'educamb' ),
            ]
        );
		$this->add_control(
			'bg_image',
