 ...
 * @since 1.0.0
 */
class Our_Testimonial_V6 extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_our_testimonial_v6';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Testimonials V6', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_testimonial_v6',
			[
				'label' => esc_html__( 'Our Testimonials V6', 'educamb' ),
			]
		);
		$this->add_control(
			'sub_title',
    ...
    <!--Start Testimonial Style6 Area-->
    <section class="testimonial-style6-area">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="testimonial-style6__title">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="testimonial-style1-content">
                        <div class="theme_carousel testimonial-carousel-style6 owl-theme owl-carousel  owl-nav-style-one text-center"
                            data-options='{
                            "loop": true, 
                            "margin": 30, 
                            "autoheight":true, 
                            ...
                            <!--Start Single Testimonial Style6-->
                            <div class="single-testimonial-style6">
                                ...
                                <div class="rating-box">
                                    <ul>
                                        <?php $rating = get_post_meta( get_the_id(), 'testimonial_rating', true );
											if(!empty($rating)){
											for ($x = 1; $x <= 5; $x++) {
												if($x <= $rating) echo '<li><span class="icon-favourite"><span class="fa fa-star"></span></span></li>'; else echo '<li><span class="icon-favourite"><span class="fa fa-star-o"></span></span></li>';
											}
										} ?>
                                    </ul>
                                </div>
                            </div>
                            <!--End Single Testimonial Style6-->
                            <?php endwhile; ?>
                        </div>
                    </div>
                </div>
