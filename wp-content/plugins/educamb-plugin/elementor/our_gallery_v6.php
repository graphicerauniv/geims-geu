 ...
 * @since 1.0.0
 */
class Our_Gallery_V6 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Gallery V6', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_gallery_v6',
			[
				'label' => esc_html__( 'Our Gallery V6', 'educamb' ),
			]
		);
		$this->add_control(
			'subtitle',
	...
	protected function render() {
		...
		<?php 
           ...
           <!--Start Single Photography Work Gallery Box -->
            <div class="col-xl-6 col-lg-6 filter-item <?php echo esc_attr($term_slug); ?>">
                <div class="single-photography-work-gallery-box">
                    <div class="img-holder">
                        <?php the_post_thumbnail('educamb_570x500'); ?>
                    </div>
            ...
            <!--Start Photography Work Gallery Page3-->
            <section class="photography-work-gallery-page3">
                <div class="container">
            ...
            <!--End Photography Work Gallery Page3-->
