...
class Our_Services_V4 extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_our_services_v4';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Services V4', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_services_v4',
			[
				'label' => esc_html__( 'Our Services V4', 'educamb' ),
			]
		);
		$this->add_control(
			'text_limit',
	...
	protected function render() {
        ...
        <!-- service-style-two -->
        <section class="service-style-two bg-color-3 centred pb-215">
