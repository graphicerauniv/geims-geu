...
class Call_To_Action_V3 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_call_to_action_v3';
    }
    ...
    public function get_title() {
        return esc_html__( 'Call To Action V3', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'call_to_action_v3',
            [
                'label' => esc_html__( 'Call To Action V3', 'educamb' ),
            ]
        );
		$this->add_control(
			'bg_image',
    ...
    <section class="slogan-style1-area gray-bg margin0">
