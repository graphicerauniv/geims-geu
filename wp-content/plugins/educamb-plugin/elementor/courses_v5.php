 ...
 * @since 1.0.0
 */
class Courses_V5 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Courses V5', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'courses_v5',
			[
				'label' => esc_html__( 'Courses V5', 'educamb' ),
			]
		);
		$this->add_control(
			'subtitle',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'View All Classes', 'educamb' ),
			]
		);
		$this->add_control(
			'btn_link',
	...
	protected function render() {
        ...
        <!--Start Cooking Classes Area-->
        <section class="cooking-classes-area">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="cooking-classes-top-title">
            ...
            <div class="auto-container">
                <ul class="cooking-classes-content clearfix">
					<?php 
						global $authordata;
					...
					?>
                    <!--Start Single Cooking Classes Content -->
                    <li class="single-cooking-classes-content-outer">
                        <div class="single-cooking-classes-content">
                            <div class="img-holder">
                                <?php if(has_post_thumbnail()){ ?>
                                <div class="inner">
                                    <?php the_post_thumbnail( 'educamb_340x270' );?>
                                </div>
                                <?php } ?>
                    ...
                    <!--End Single Cooking Classes Content -->
                    <?php endwhile; ?>
                </ul>
            </div>
        </section>
        <!--End Cooking Classes Area-->
