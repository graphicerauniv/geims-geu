 ...
 * @since 1.0.0
 */
class Banner_V9 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Banner V9', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'banner_v9',
            [
                'label' => esc_html__( 'Banner V9', 'educamb' ),
            ]
        );
		$this->add_control(
            'slides', 
				...
				[
					...
					[
						...
						'options' => array(
							...
							'three' => esc_html__( 'Choose Style Text Align Center', 'educamb' ),
						),
					],
				],
				'title_field' => '{{title}}',
            ...
            <div class="banner-carousel owl-theme owl-carousel">
                ...
                <div class="slide">
                    ...
                    <div class="auto-container">
                        <div class="<?php if($item['style_two'] == 'three') echo 'content text-center'; elseif($item['style_two'] == 'two') echo 'content text-right'; else echo 'content'; ?>">
