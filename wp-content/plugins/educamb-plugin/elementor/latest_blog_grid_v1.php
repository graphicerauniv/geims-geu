 ...
 * @since 1.0.0
 */
class Latest_Blog_Grid_V1 extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_latest_blog_grid_v1';
	}
	...
	public function get_title() {
		return esc_html__( 'Latest Blog Grid V1', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'latest_blog_grid_v1',
			[
				'label' => esc_html__( 'Latest Blog Grid V1', 'educamb' ),
			]
		);
		$this->add_control(
			'style_two',
			 [
				...
				'default' => 'one',
				'options' => array(
				'one' => esc_html__( 'Choose Style Grid View', 'educamb' ),
				'two' => esc_html__( 'Choose Style Grid View Photography', 'educamb' ),
				),
			 ]
		);
		$this->add_control(
    ...
    <!--Start Blog Page One -->
    <section class="blog-page-one photography-blog-page-one">
        <div class="container">
            <div class="row">
                            ...
                            <div class="meta-info">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <a href="<?php echo get_month_link(get_the_date('Y'), get_the_date('m')); ?>"><?php echo esc_attr(get_the_date()); ?></a>
                                    </li>
                                </ul>
                            </div>
                            <h3>
