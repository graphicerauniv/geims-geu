 ...
 * @since 1.0.0
 */
class Academy_Courses_Category extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_academy_courses_category';
    }
    ...
    public function get_title() {
        return esc_html__( 'Academy Courses Category', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Academy Courses Category', 'educamb' ),
            ]
        );
		$this->add_control(
			'sidebar_slug',
	...
	protected function render() {
        ...
        <!--Start Academy Courses Category Area-->
        <section class="academy-courses-category-area">
            <div class="container">
                <div class="row">
                    ...
                    <div class="<?php if ( is_active_sidebar( $settings['sidebar_slug'] ) ) echo 'col-xl-9 order-1 '; else echo 'col-xl-12 col-lg-12'; ?>">
        ...
        <!--End Academy Courses Category Area-->
