 ...
 * @since 1.0.0
 */
class Social_Activity_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_social_activity_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Social Activity V2', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'social_activity_v2',
			[
				'label' => esc_html__( 'Social Activity V2', 'educamb' ),
