...
class Our_Testimonial_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_our_testimonial_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Testimonials V2', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_testimonial_v2',
			[
				'label' => esc_html__( 'Our Testimonials V2', 'educamb' ),
			]
		);
		$this->add_control(
			'pattern_image',
    ...
    <section class="testimonial-style2-area">
        ...
        <div class="testimonial-style2-area-shape"
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="testimonial-style2__title">
                    ...
                    <div class="testimonial-style1-content">
                        <div class="theme_carousel testimonial-carousel owl-theme owl-carousel" data-options='{
                            ...
                            <div class="single-testimonial-style2 text-center">
                                ...
                                <div class="img-box">
                                    <div class="inner">
                                        <?php the_post_thumbnail('educamb_130x130'); ?>
                                    </div>
                                    <div class="img-outer">
                                        <?php $icon_image = get_post_meta( get_the_id(), 'author_image', true ); ?>
