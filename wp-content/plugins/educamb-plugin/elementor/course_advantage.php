 ...
 * @since 1.0.0
 */
class Course_Advantage extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_course_advantage';
    }
    ...
    public function get_title() {
        return esc_html__( 'Course Advantage', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'course_advantage',
            [
                'label' => esc_html__( 'Course Advantage', 'educamb' ),
            ]
        );
		$this->add_control(
			'subtitle',
    ...
    <!--Start Course Advantage Area-->
    <section class="course-advantage-area">
        <div class="container">
            ...
            <div class="row">
                ...
                <!--Start Single Course Advantage Box-->
                <div class="col-xl-4 col-lg-6 col-md-6 text-center">
                    <div class="single-course-advantage-box">
                        <div class="single-course-advantage-box-overlay-bg"
                ...
                <!--End Single Course Advantage Box-->
                <?php $i++; endforeach; ?>
            </div>
        </div>
    </section>
    <!--End Course Advantage Area--> 
