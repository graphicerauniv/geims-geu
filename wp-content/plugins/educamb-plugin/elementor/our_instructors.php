 ...
 * @since 1.0.0
 */
class Our_Instructors extends Widget_Base {
	/**
	 * Get widget name.
	...
	public function get_name() {
		return 'educamb_our_instructors';
	}
	/**
	 * Get widget title.
	...
	public function get_title() {
		return esc_html__( 'Our Instructors', 'educamb' );
	}
	/**
	 * Get widget icon.
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_instructors',
			[
				'label' => esc_html__( 'Our Instructors', 'educamb' ),
			]
		);
		$this->add_control(
			'sub_title',
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="single-team-style2 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                        <div class="img-holder">
                            <div class="inner">
                                <?php the_post_thumbnail('educamb_240x370'); ?>
                            </div>
                            <div class="title-holder text-center">
                                <div class="img-bg" style="background-image: url('<?php echo esc_url($post_thumbnail_url); ?>');"></div>
