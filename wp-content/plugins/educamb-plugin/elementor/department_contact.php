 ...
 * @since 1.0.0
 */
class Department_Contact extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_department_contact';
    }
    ...
    public function get_title() {
        return esc_html__( 'Department Contact', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'department_contact',
            [
                'label' => esc_html__( 'Department Contact', 'educamb' ),
            ]
        );
		$this->add_control(
			'title',
                        ...
                        <div class="theme_carousel department-carousel owl-theme owl-carousel owl-dot-style1"
                            ...
                            <div class="department-style1-single">
                                ...
                                <div class="bottom-content">
                                    ...
                                    <a href="mailto:<?php echo esc_attr($item['block_email']); ?>"><?php esc_html_e('“E-Mail Us!”', 'educamb');?></a>
                                </div>
                            </div>
