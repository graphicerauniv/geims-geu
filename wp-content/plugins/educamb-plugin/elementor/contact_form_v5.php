 ...
 * @since 1.0.0
 */
class Contact_Form_V5 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_contact_form_v5';
    }
    ...
    public function get_title() {
        return esc_html__( 'Contact Form V5', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'contact_form_v5',
            [
                'label' => esc_html__( 'Contact Form V5', 'educamb' ),
            ]
        );
		$this->add_control(
			'form_sub_title',
    ...
    <!--Start Main Contact Form Style5 Area-->
    <section class="main-contact-form-style5-area">
        <div class="container">
            <div class="row">
    ...
    <!--End Main Contact Form Style5 Area-->
