 ...
 * @since 1.0.0
 */
class Who_We_Are_V4 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Who We Are V4', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'who_we_are_v4',
            [
                'label' => esc_html__( 'Who We Are V4', 'educamb' ),
            ]
        );
		$this->add_control(
			'subtitle',
		...
		$this->add_control(
			'since',
			[
				'label'       => __( 'Since Year', 'educamb' ),
				'label_block' => true,
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'Enter your Year', 'educamb' ),
			]
		);
		$this->add_control(
			'text',
    ...
    <!--Start About Style7 Area-->
    <section class="about-style7-area">
        <div class="about-style7-area-gray-bg"></div>
        <div class="container">
            <div class="row">
                <div class="col-xl-4">
                    <div class="about-style7-content-one">
                        ...
                        <div class="inner-text">
                            <?php if($settings['since']) { ?><h3><?php echo wp_kses($settings['since'], true);?></h3><?php } ?>
