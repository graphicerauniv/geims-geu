...
class Contact_Us extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Contact Us', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'contact_us',
            [
                'label' => esc_html__( 'Contact Us', 'educamb' ),
            ]
        );
		$this->add_control(
			'feature_image',
    ...
    protected function render() {
        ...
        ?>
          ...
          <!-- contact-section -->
        <section class="contact-section" style="background-image: url(<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/background/contact-1.jpg);">
            <div class="auto-container">
                <div class="row align-items-center clearfix">
                	<?php if($settings['feature_image']['id']){ ?>
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <figure class="image-box"><img src="<?php echo esc_url(wp_get_attachment_url($settings['feature_image']['id'])); ?>" alt="<?php esc_attr_e('Awesome Image', 'educamb'); ?>"></figure>
                    </div>
                    <?php } ?>
