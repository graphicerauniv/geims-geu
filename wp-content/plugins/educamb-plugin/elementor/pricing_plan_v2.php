...
class Pricing_Plan_V2 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_pricing_plan_v2';
    }
    ...
    public function get_title() {
        return esc_html__( 'Pricing Plan V2', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'pricing_plan_v2',
            [
                'label' => esc_html__( 'Pricing Plan V2', 'educamb' ),
            ]
        );
		$this->add_control(
			'sub_title',
		...
		$this->add_control(
		  ...
		  [
				...
				[
					[
						'name' => 'block_bg_text',
						'label' => esc_html__('BG Text', 'educamb'),
						'label_block' => true,
						'type' => Controls_Manager::TEXT,
					],
					[
    ...
    <!--Start Pricing Plans Style6 Area-->
    <section class="pricing-plans-style6-area">
        <div class="container">
            ...
            <div class="row">
                ...
                <!--Start Single Pricing Plans Style6-->
                <div class="col-xl-6">
                    <div class="single-pricing-plans-box-style6">
                        <div class="big-text"><?php echo wp_kses($item['block_bg_text'], true);?></div>
                        <div class="top">
						...
						<ul>
							...
							<li><div class="icon"><span class="flaticon-draw-check-mark"></span></div><p><?php echo wp_kses($features, true); ?></p></li>
							<?php endforeach; ?>
						</ul>
                        <?php } ?>
                        <?php if($item['block_btn_title']) { ?>
                        <div class="btns-box">
                            <a class="btn-one btn-one--style6" href="<?php echo esc_url($item['block_btn_link']['url']); ?>">
                                <span class="txt">
                ...
                <!--End Single Pricing Plans Style6-->
				<?php endforeach; ?>
            </div>
        </div>
    </section>
    <!--End Pricing Plans Style6 Area-->    
