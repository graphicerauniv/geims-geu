 ...
 * @since 1.0.0
 */
class Our_Feature_V5 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Our Feature V5', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'our_feature_v5',
            [
                'label' => esc_html__( 'Our Feature V5', 'educamb' ),
            ]
        );
		$this->add_control(
           'features', 
    ...
    !--Start Cta Style6 Area-->
    <section class="cta-style6-area">
        <div class="container">
            <div class="cta-style6__content">
                <ul class="row">
                    <?php foreach($settings['features'] as $key => $item): ?>
                    <!--Start Single Cta Style6 Box-->
                    <li class="col-xl-3">
                        <div class="single-cta-style6-box">
                            <div class="icon">
