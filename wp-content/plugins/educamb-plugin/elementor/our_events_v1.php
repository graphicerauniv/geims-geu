 ...
 * @since 1.0.0
 */
class Our_Events_V1 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Our Events V1', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'our_events_v1',
            [
                'label' => esc_html__( 'Our Events V1', 'educamb' ),
			]
        );
		$this->add_control(
			'title',
    ...
    protected function render() {
        ...
        if( educamb_set( $settings, 'query_category' ) ) $args['tribe_events_cat'] = educamb_set( $settings, 'query_category' );
                    ...
                    <div class="event-style1-content-box">
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="single-event-box-style1 <?php if($count==2) echo 'single-event-box-style1--style2'; else echo ''; ?>">
                                    <div class="date-box">
                                        <h2><?php echo wp_kses($start_date, true); ?></h2>
                                        <p><?php echo wp_kses($start_month, true); ?>, <?php echo wp_kses($start_year, true); ?></p>
                                    </div>
                                    <div class="title-box">
                                        <div class="event-time">
                                            <span class="icon-clock"></span>
                                            <p><?php echo wp_kses($start_time, true); ?> - <?php echo wp_kses($end_time, true); ?></p>
                                        </div>
                                        <h3>
