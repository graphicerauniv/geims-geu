 ...
 * @since 1.0.0
 */
class Contact_Info_V3 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_contact_info_v3';
    }
    ...
    public function get_title() {
        return esc_html__( 'Contact Info V3', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'contact_info_v3',
            [
                'label' => esc_html__( 'Contact Info V3', 'educamb' ),
            ]
        );
		$this->add_control(
		    'info', 
