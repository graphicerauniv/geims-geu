 ...
 * @since 1.0.0
 */
class Our_Testimonial_V8 extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_our_testimonial_v8';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Testimonials V8', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_testimonial_v8',
			[
				'label' => esc_html__( 'Our Testimonials V8', 'educamb' ),
			]
		);
		$this->add_control(
			'title',
    ...
    <!--Start Testimonial Style8 Area-->
    <section class="testimonial-style8-area">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="testimonial-style7-content">
                        <div class="theme_carousel testimonial-carousel-style8 owl-theme owl-carousel owl-nav-style-one"
                            data-options='{
                                "loop": true, 
                                "margin": 30, 
                                "autoheight":true, 
