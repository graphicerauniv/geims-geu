 ...
 * @since 1.0.0
 */
class Our_Testimonial_V3 extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_our_testimonial_v3';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Testimonials V3', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_testimonial_v3',
			[
				'label' => esc_html__( 'Our Testimonials V3', 'educamb' ),
			]
		);
		$this->add_control(
			'image',
                ...
                <div class="col-xl-6">
                    <div class="testimonial-style3__text-box">
                        ...
                        <div class="testimonial-style3__text-box__inner">
                            ...
                            <div class="theme_carousel testimonial-style3-carousel owl-theme owl-carousel owl-nav-style-one"
                                data-options='{
                                "loop": false, 
                                "margin": 0, 
                                "autoheight":true, 
