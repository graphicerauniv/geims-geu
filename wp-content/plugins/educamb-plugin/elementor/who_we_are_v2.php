 ...
 * @since 1.0.0
 */
class Who_We_Are_V2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Who We Are V2', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'who_we_are_v2',
            [
                'label' => esc_html__( 'Who We Are V2', 'educamb' ),
            ]
        );
		$this->add_control(
		  'features', 
		  [
				...
				'default' => 
					[
						['block_title' => esc_html__('Years Experienced', 'educamb')],
						['block_title' => esc_html__('Years Experienced', 'educamb')],
					],
				'fields' => 
				[
					...
					[
						'name' => 'block_year',
						'label' => esc_html__('Experience Year', 'educamb'),
						'label_block' => true,
		...
		$this->add_control(
		  ...
		  [
				...
				'default' => 
					[
						['block_title' => esc_html__('Short Story', 'educamb')],
						['block_title' => esc_html__('Our Experience', 'educamb')],
					],
				'fields' => 
				[
					[
            ...
            <div class="row">
                    ...
                    <div class="about-style3-img-box">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="about-style3-single-img-box <?php if($item['style_two'] == 'two') echo ''; else echo 'margin-top'; ?>">
                                    <img src="<?php echo esc_url(wp_get_attachment_url($item['image']['id'])); ?>" alt="<?php esc_attr_e('Awesome Image', 'educamb');?>">
                                    <div class="overlay-bg <?php if($item['style_two'] == 'two') echo 'bg-black'; else echo ''; ?>"></div>
                ...
                <div class="col-xl-6">
                    <div class="about-style3-content">
                        ...
                        <div class="about-style3-content__inner">
                            <ul>
