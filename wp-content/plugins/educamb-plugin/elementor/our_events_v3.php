 ...
 * @since 1.0.0
 */
class Our_Events_V3 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Our Events V3', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'our_events_v3',
            [
                'label' => esc_html__( 'Our Events V3', 'educamb' ),
			]
        );
		$this->add_control(
			'style_two',
    ...
    <section class="<?php if($settings['style_two'] == 'two') echo 'events-page-one'; else echo 'events-style1-area'; ?>">
        <div class="container">
                    ...
                    <div class="single-event-one">
                        <div class="single-event-one__inner">
                            <div class="img-holder">
                                <?php echo (get_the_post_thumbnail($event->ID, 'educamb_340x300')); ?>
                            ...
                            <div class="text-holder">
                                ...
                                <div class="text">
                                    <p>
									<?php echo wp_trim_words( tribe_events_get_the_excerpt( $event->ID ), $settings['text_limit'] ); ?>
                                    </p>
                                </div>
                                <ul>
