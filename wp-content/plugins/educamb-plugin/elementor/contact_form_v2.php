...
class Contact_Form_V2 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_contact_form_v2';
    }
    ...
    public function get_title() {
        return esc_html__( 'Contact Form V2', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'contact_form_v2',
            [
                'label' => esc_html__( 'Contact Form V2', 'educamb' ),
            ]
        );
		$this->add_control(
			'title',
		...
		$this->add_control(
		    ...
		    [
				...
				'default' => 
					[
						['block_title' => esc_html__('Enquires', 'educamb')],
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    ...
                    <div class="consultation-content-box">
                        <div class="consultation-content-box-img" <?php if($settings['image']['id']){ ?>
                            style="background-image: url(<?php echo esc_url(wp_get_attachment_url($settings['image']['id'])); ?>);"<?php } ?>>
                        </div>
