 ...
 * @since 1.0.0
 */
class Our_Gallery_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Gallery V2', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_gallery_v2',
			[
				'label' => esc_html__( 'Our Gallery V2', 'educamb' ),
			]
		);
		$this->add_control(
			'sub_title',
    ...
    <section class="photography-work-gallery-area">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="photography-work-gallery__top-title">
            ...
            <div class="row masonary-layout">
                ...
                <div class="<?php if(get_post_meta( get_the_id(), 'project_dimension', true) == 'mixmum_height_1') echo 'col-xl-4 col-lg-6 col-md-6';  else echo 'col-xl-4 col-lg-6 col-md-6'?>">
