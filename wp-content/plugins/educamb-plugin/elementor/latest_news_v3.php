...
class Latest_News_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News V3', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'latest_news_v3',
			[
				'label' => esc_html__( 'Latest News V3', 'educamb' ),
			]
		);
		$this->add_control(
			'style_two',
    ...
    <!--Start Blog Style4 Area-->
    <section class="<?php if($settings['style_two'] == 'two') echo 'blog-style4-area marketplace-blog-page-one'; else echo 'blog-style4-area'; ?>">
