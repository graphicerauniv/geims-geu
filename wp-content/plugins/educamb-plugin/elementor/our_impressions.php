 ...
 * @since 1.0.0
 */
class Our_Impressions extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_our_impressions';
    }
    ...
    public function get_title() {
        return esc_html__( 'Our Impressions', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'our_impressions',
            [
                'label' => esc_html__( 'Our Impressions', 'educamb' ),
            ]
        );
		$this->add_control(
			'bg_image',
    ...
    <!--Start Impressions Area-->
    <section class="impressions-area">
        <div class="impressions-area-img-bg" <?php if($settings['bg_image']['id']){ ?>
            style="background-image: url(<?php echo esc_url(wp_get_attachment_url($settings['bg_image']['id'])); ?>);"<?php } ?>></div>
        <div class="container">
            <div class="row">
                <div class="col-xl-6"></div>
                <div class="col-xl-6">
                    <div class="impressions__content-box">
                        ...
                        <?php } ?>
                        <div class="impressions__content-box__inner">
                            <div class="row masonary-layout">
                                <?php foreach($settings['slide'] as $key => $item): ?>
                                <!--Start Signle Impressions Content Box-->
                                <div class="col-xl-6 col-lg-6 col-md-6">
                                    <div class="single-impressions-content-box <?php if($item['style_two'] == 'two') echo 'margin-top50'; else echo ''; ?>">
                                ...
                                <!--End Signle Impressions Content Box-->
                                <?php endforeach; ?>
                            </div>
                        </div>
                    </div>
