...
class Our_Project_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Projects V2', 'educamb' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'left_view',
            [
                'label' => esc_html__( 'Left Two Image View', 'educamb' ),
				'tab' => Controls_Manager::TAB_LAYOUT,
            ]
        );
		$this->add_control(
		...
		$this->start_controls_section(
            'right_view',
            [
                'label' => esc_html__( 'Right Three Image View', 'educamb' ),
				'tab' => Controls_Manager::TAB_LAYOUT,
            ]
        );
		$this->add_control(
	...
	protected function render() {
		...
		if( educamb_set( $settings, 'query_categorys' ) ) $args2['project_cat'] = educamb_set( $settings, 'query_categorys' );
        ...
        <section class="gallery-style-two">
            <div class="auto-container">
                ...
                <div class="sec-title">
                    ...
                    <div class="btn-box"><a href="<?php echo esc_url($settings['btn_link']['url']);?>" class="theme-btn"><?php echo wp_kses($settings['btn_title'], true);?> <i class="far fa-angle-double-right"></i></a></div>
                    <?php } ?>
                </div>
                
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-12 col-sm-12 small-block">
                        <?php 
							global $post;
							...
							<div class="inner-box">
								...
								<?php 
									...
									if($dimention == 'extra_height'){
										$image_size = 'educamb_370x370';
									}else{
										$image_size = 'educamb_370x290'; 
									}
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 big-block">
                        <div class="row clearfix">
                            <?php 
								global $post;
								...
								$post_thumbnail_url = wp_get_attachment_url( $post_thumbnail_id );
							?>
                            <div class="gallery-block <?php if(get_post_meta( get_the_id(), 'project_dimension', true) == 'extra_width') echo 'col-lg-12 col-md-12 col-sm-12'; elseif(get_post_meta( get_the_id(), 'project_dimension', true) == 'extra_height') echo 'col-lg-6 col-md-12 col-sm-12'; else echo 'col-lg-6 col-md-12 col-sm-12'?>">
                                <div class="project-block-one">
                                    <div class="inner-box">
                                        <figure class="image-box">
                                        <?php 
											...
											if($dimention == 'extra_width'){
												$image_size = 'educamb_770x370';
											} elseif($dimention == 'extra_height'){
												$image_size = 'educamb_370x410';
											} else{
												$image_size = 'educamb_370X370'; 
											}
											the_post_thumbnail($image_size);
