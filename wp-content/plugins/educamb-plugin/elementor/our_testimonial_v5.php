...
class Our_Testimonial_V5 extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_our_testimonial_v5';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Testimonials V5', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_testimonial_v5',
			[
				'label' => esc_html__( 'Our Testimonials V5', 'educamb' ),
			]
		);
		$this->add_control(
			'bg_text',
				...
				[
					...
					[
						...
						'options' => array(
							...
							'five' => esc_html__( 'Choose Style Five', 'educamb' ),
							'six' => esc_html__( 'Choose Style Six', 'educamb' ),
							'seven' => esc_html__( 'Choose Style Seven', 'educamb' ),
						),
					],
				],
			 ]
    ...
    <!--Start Testimonial Style5 Area-->
    <section class="testimonial-style5-area">
        <div class="testimonial-style5-area__inner-bg"></div>
        <?php if($settings['bg_text']) { ?><div class="big-text"><?php echo wp_kses($settings['bg_text'], true);?></div><?php } ?>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="testimonial-style1-content">
						<?php foreach($settings['client'] as $key => $item): ?>
                        <div class="<?php if($item['style_two'] == 'seven') echo 'testimonial-style5-area__single-box-7 paroller'; elseif($item['style_two'] == 'six') echo 'testimonial-style5-area__single-box-6 paroller'; elseif($item['style_two'] == 'five') echo 'testimonial-style5-area__single-box-5 float-bob-y'; elseif($item['style_two'] == 'four') echo 'testimonial-style5-area__single-box-4 paroller-2'; elseif($item['style_two'] == 'three') echo 'testimonial-style5-area__single-box-3 zoom-fade'; elseif($item['style_two'] == 'two') echo 'testimonial-style5-area__single-box-2 zoom-fade'; else echo 'testimonial-style5-area__single-box-1 zoom-fade'; ?>">
                            <img src="<?php echo esc_url(wp_get_attachment_url($item['image1']['id']));?>" alt="<?php esc_attr_e('Awesome Image', 'educamb'); ?>">
                        </div>
                        <?php endforeach;?>
                                ...
                                <div class="testimonial-style3__text-box__inner">
                                    ...
                                    <div class="single-testimonial-style3">
                                        <div class="top">
                                            ...
                                            <div class="right">
                                                <div class="social-links">
                                                    <?php
														$icons = get_post_meta( get_the_id(), 'testi_social_profile', true );
														if ( ! empty( $icons ) ) :
													?>
													<ul>
                                        ...
                                        <div class="bottom">
                                            ...
                                            <div class="right">
                                                <div class="date-box">
                                                    <p><?php echo (get_post_meta( get_the_id(), 'testimonial_date', true ));?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
