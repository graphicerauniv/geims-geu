 ...
 * @since 1.0.0
 */
class Latest_Blog_Grid_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_latest_blog_grid_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Latest Blog Grid V2', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'latest_blog_grid_v2',
			[
				'label' => esc_html__( 'Latest Blog Grid V2', 'educamb' ),
			]
		);
		$this->add_control(
			'style_two',
			[
				...
				'default' => 'one',
				'options' => array(
					'one' => esc_html__( 'Choose Four Column Style', 'educamb' ),
					'two' => esc_html__( 'Choose Three Column Style ', 'educamb' ),
				),
			]
		);
		$this->add_control(
    ...
    <section class="blog-style7-area cooking-blog-page-two">
        <div class="container">
            <div class="row">
    ...
    <!--Start Blog Style7 Area-->
    <section class="blog-style7-area cooking-blog-page-one">
        <div class="container">
            <div class="row">
				<?php while ( $query->have_posts() ) : $query->the_post(); ?>
