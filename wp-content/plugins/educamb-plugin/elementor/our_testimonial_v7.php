 ...
 * @since 1.0.0
 */
class Our_Testimonial_V7 extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_our_testimonial_v7';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Testimonials V7', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_testimonial_v7',
			[
				'label' => esc_html__( 'Our Testimonials V7', 'educamb' ),
			]
		);
		$this->add_control(
			'video_image',
    ...
    <!--Start Testimonial Style7 Area-->
    <section class="testimonial-style7-area">
        <div class="container">
            <div class="row">

                <div class="col-xl-6">
                    <div class="testimonial-style7-video-gallery-box">
                        <div class="roate-bg"></div>
                        <div class="testimonial-style7-video-gallery-box__inner" <?php if($settings['video_image']['id']) { ?>
                            style="background-image: url(<?php echo esc_url(wp_get_attachment_url($settings['video_image']['id'])); ?>);"<?php } ?>>
                ...
                <div class="col-xl-6">
                    <div class="testimonial-style7-content">
                        ...
                        <div class="theme_carousel testimonial-carousel-style7 owl-theme owl-carousel owl-nav-style-one"
                            data-options='{
                                "loop": false, 
                                "margin": 0, 
                                "autoheight":true, 
                            ...
                            <!--Start Single Testimonial Style7-->
                            <div class="single-testimonial-style7">
                                ...
                                <div class="client-info">
                                    ...
                                    <div class="img-box">
                                        <?php the_post_thumbnail('educamb_100x100'); ?>
                                    </div>
                                </div>
                            </div>
                            <!--End Single Testimonial Style7-->
							<?php endwhile; ?>
