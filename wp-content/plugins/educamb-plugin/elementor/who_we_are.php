...
class Who_We_Are extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Who We Are', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'who_we_are',
            [
                'label' => esc_html__( 'Who We Are', 'educamb' ),
            ]
        );
		$this->add_control(
			'choose_us_img',
			[
				'label' => __( 'Choose Us Image', 'educamb' ),
            ...
            <div class="auto-container">
                <div class="row align-items-center clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                       <?php if($settings['choose_us_img']['id']){ ?>
                        <div class="image-box">
                            <figure class="image"><img src="<?php echo esc_url(wp_get_attachment_url($settings['choose_us_img']['id'])); ?>" alt="<?php esc_attr_e('Awesome Image', 'educamb'); ?>"></figure>
                        </div>
                        <?php } ?>
                    </div>
                        ...
                        <div class="content_block_5">
                            <div class="content-box">
                               <?php if($settings['subtitle'] || $settings['title']) { ?>
                                ...
                                <div class="btn-box"><a href="<?php echo esc_url($settings['btn_link']['url']);?>" class="theme-btn style-one"><?php echo wp_kses($settings['btn_title'], true);?><i class="far fa-angle-double-right"></i></a></div>
                           		<?php } ?>
                            </div>
                        </div>
                    </div>
