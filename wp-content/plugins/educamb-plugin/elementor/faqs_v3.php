 ...
 * @since 1.0.0
 */
class Faqs_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Faqs V3', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'faqs_v3',
			[
				'label' => esc_html__( 'Faqs V3', 'educamb' ),
			]
		);
		$this->add_control(
			'image',
    ...
    <!--Start marketplace Faq Area-->
    <section class="marketplace-faq-area">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <div class="marketplace-faq-content">
                        ...
                        <div class="marketplace-faq-content__inner">
                ...
                <div class="col-xl-6">
                    <div class="marketplace-faq-img-box">
                        <div class="inner">
