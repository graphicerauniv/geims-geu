 ...
 * @since 1.0.0
 */
class Explore_Your_Direction extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_explore_your_direction';
    }
    ...
    public function get_title() {
        return esc_html__( 'Explore Your Direction', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'explore_your_direction',
            [
                'label' => esc_html__( 'Explore Your Direction', 'educamb' ),
            ]
        );
		$this->add_control(
			'title',
