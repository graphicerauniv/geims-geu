...
class Contact_Info_V2 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_contact_info_v2';
    }
    ...
    public function get_title() {
        return esc_html__( 'Contact Info V2', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'contact_info_v2',
            [
                'label' => esc_html__( 'Contact Info V2', 'educamb' ),
            ]
        );
		$this->add_control(
		    'info', 
		    [
				...
				'default' => 
					[
						...
						['block_title' => esc_html__('General Enquires', 'educamb')],
						['block_title' => esc_html__('Office Hours', 'educamb')],
						['block_title' => esc_html__('Social Media', 'educamb')]
					],
				'fields' => 
				[
					[
    ...
    <!--Start Contact Details Style2 Area-->
                ...
                <div class="col-xl-12">
                    <div class="contact-details-style2-box">
                        <ul class="clearfix">
                            <?php 
								  $count = 0;  
								  foreach($settings['info'] as $key => $item): 
							?>
