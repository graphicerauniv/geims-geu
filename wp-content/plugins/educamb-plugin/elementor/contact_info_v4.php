 ...
 * @since 1.0.0
 */
class Contact_Info_V4 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_contact_info_v4';
    }
    ...
    public function get_title() {
        return esc_html__( 'Contact Info V4', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'contact_info_v4',
            [
                'label' => esc_html__( 'Contact Info V4', 'educamb' ),
            ]
        );
		$this->add_control(
		    'info', 
		    [
				...
				'default' => 
					[
						...
						['block_title' => esc_html__('Faq’s', 'educamb')]
					],
				'fields' => 
				[
					[
    ...
    <!--Start Contact Info Style6 Area-->
    <section class="contact-info-style6-area">
        <div class="container">
            <div class="row">
