 ...
 * @since 1.0.0
 */
class Explore_Your_Direction_V2 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_explore_your_direction_v2';
    }
    ...
    public function get_title() {
        return esc_html__( 'Explore Your Direction V2', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'explore_your_direction_v2',
            [
                'label' => esc_html__( 'Explore Your Direction V2', 'educamb' ),
            ]
        );
		$this->add_control(
			'style_two',
	       ...
	       [
				...
				[
					...
					[
						...
						'label' => __( 'Button Link 2', 'educamb' ),
						'type' => Controls_Manager::URL,
						'placeholder' => __( 'https://your-link.com', 'plugin-domain' ),
						'show_external' => true,
						'default' => ['url' => '','is_external' => true,'nofollow' => true,],
					...
					[
						...
						'label' => __( 'Button Link 3', 'educamb' ),
						'type' => Controls_Manager::URL,
						'placeholder' => __( 'https://your-link.com', 'plugin-domain' ),
						'show_external' => true,
						'default' => ['url' => '','is_external' => true,'nofollow' => true,],
					...
					[
						...
						'label' => __( 'Button Link 4', 'educamb' ),
						'type' => Controls_Manager::URL,
						'placeholder' => __( 'https://your-link.com', 'plugin-domain' ),
						'show_external' => true,
						'default' => ['url' => '','is_external' => true,'nofollow' => true,],
					...
					[
						'name' => 'block_btn_title5',
						'label' => esc_html__('Button Title 5', 'educamb'),
						'label_block' => true,
						'type' => Controls_Manager::TEXT,
					],
					[
						'name' => 'block_btn_link5',
						'label' => __( 'Button Link 5', 'educamb' ),
						'type' => Controls_Manager::URL,
						'placeholder' => __( 'https://your-link.com', 'plugin-domain' ),
						'show_external' => true,
						'default' => ['url' => '','is_external' => true,'nofollow' => true,],
    ...
    <section class="<?php if($settings['style_two'] == 'three') echo 'explore-direction-area explore-direction-area--style2 pdb50'; elseif($settings['style_two'] == 'two') echo 'explore-direction-area pdb50'; else echo 'explore-direction-area'; ?>">
        <div class="container">
            <div class="sec-title">
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-12">
                                        <div class="text-box">
                                            ...
                                            <div class="btns-box">
                                                <a class="btn-one <?php if($settings['style_two'] == 'two') echo 'btn-one-style7'; else echo 'btn-one--style2'; ?>" href="<?php echo esc_url($item['block_btn_link']['url']); ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="img-box__item">
                                                        <ul>
                                                            <li>
                                                                <a href="<?php echo esc_url($item['block_btn_link2']['url']); ?>">
                                                                    <span><?php echo wp_kses($item['block_btn_title2'], true);?></span>
                                                                    <i class="icon-diagonal-arrow"></i>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo esc_url($item['block_btn_link3']['url']); ?>">
                                                                    <span><?php echo wp_kses($item['block_btn_title3'], true);?></span>
                                                                    <i class="icon-diagonal-arrow"></i>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo esc_url($item['block_btn_link4']['url']); ?>">
                                                                    <span><?php echo wp_kses($item['block_btn_title4'], true);?></span>
                                                                    <i class="icon-diagonal-arrow"></i>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="img-box__img">
                                                        ...
                                                        <div class="img-box__img-overlay">
                                                            <a href="<?php echo esc_url($item['block_btn_link5']['url']); ?>">
                                                                <span class="icon-down-arrow-1"></span><?php echo wp_kses($item['block_btn_title5'], true);?>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
