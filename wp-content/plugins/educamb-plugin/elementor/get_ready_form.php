 ...
 * @since 1.0.0
 */
class Get_Ready_Form extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Get Ready Form', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'get_ready_form',
            [
                'label' => esc_html__( 'Get Ready Form', 'educamb' ),
            ]
        );
		$this->add_control(
			'image',
                ...
                <div class="col-xl-12">
                    <div class="virtual-store__content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <div class="virtual-store-form-box">
                            <form class="virtual-store-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                                <input type="text" name="s" value="<?php echo get_search_query(); ?>" placeholder="<?php echo esc_attr__( 'Search by topics...', 'educamb' ); ?>">
