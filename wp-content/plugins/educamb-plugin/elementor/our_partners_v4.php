 ...
 * @since 1.0.0
 */
class Our_Partners_V4 extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_our_partners_v4';
    }
    ...
    public function get_title() {
        return esc_html__( 'Our Partners V4', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'our_partners_v4',
            [
                'label' => esc_html__( 'Our Partners V4', 'educamb' ),
            ]
        );
		$this->add_control(
			'style_two',
    ...
    <!--Start Partner Style4 Area-->
    <section class="<?php if($settings['style_two'] == 'two') echo 'partner-style4-area border-topbottom'; else echo 'partner-style4-area'; ?>">
