 ...
 * @since 1.0.0
 */
class Our_Testimonial_V4 extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_our_testimonial_v4';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Testimonials V4', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_testimonial_v4',
			[
				'label' => esc_html__( 'Our Testimonials V4', 'educamb' ),
			]
		);
		$this->add_control(
			'show_pattern_images',
    ...
    <section class="testimonial-style4-area">
        ...
        <div class="testimonial-style4-area-shape1">
            <img class="float-bob" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/instructor/shape/testimonial-style4-area-shape-1.png" alt="<?php esc_attr_e('Awesome Image', 'educamb');?>">
        </div>
        <div class="testimonial-style4-area-shape2">
            <img class="float-bob-y" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/instructor/shape/testimonial-style4-area-shape-2.png"
                alt="<?php esc_attr_e('Awesome Image', 'educamb');?>">
        </div>
        <div class="testimonial-style4-area-shape3">
            <img class="zoom-fade" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/instructor/shape/testimonial-style4-area-shape-3.png" alt="<?php esc_attr_e('Awesome Image', 'educamb');?>">
        </div>
        <?php } ?>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="testimonial-style4__title">
