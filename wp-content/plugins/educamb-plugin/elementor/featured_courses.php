 ...
 * @since 1.0.0
 */
class Featured_Courses extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_featured_courses';
	}
	...
	public function get_title() {
		return esc_html__( 'Featured Courses', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'featured_courses',
			[
				'label' => esc_html__( 'Featured Courses', 'educamb' ),
			]
		);
		$this->add_control(
			'title',
	...
	protected function render() {
        ...
        <section class="instructor-courses-area gray-bg">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="instructor-courses__btns-box style2">
