 ...
 * @since 1.0.0
 */
class Choosing_Educamb extends Widget_Base {
    ...
    public function get_name() {
        return 'educamb_choosing_educamb';
    }
    ...
    public function get_title() {
        return esc_html__( 'Choosing Educamb', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'choosing_educamb',
            [
                'label' => esc_html__( 'Choosing Educamb', 'educamb' ),
            ]
        );
		$this->add_control(
			'bg_image',
    ...
    <!--Start Marketplace Why Choose Area-->
    <section class="marketplace-why-choose-area">
        ...
        <div class="marketplace-why-choose-area-bg"
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="theme_carousel marketplace-why-choose-carousel owl-theme owl-carousel owl-nav-style-one"
                        data-options='{
                                "loop": true, 
                                "margin": 30, 
                                "autoheight":true, 
                        ...
                        <div class="marketplace-why-choose-single-box text-center">
                            <div class="icon">
    ...
    <!--End Marketplace Why Choose Area-->       
