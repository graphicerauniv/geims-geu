 ...
 * @since 1.0.0
 */
class Banner_V10 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Banner V10', 'educamb' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'banner_v10',
            [
                'label' => esc_html__( 'Banner V10', 'educamb' ),
            ]
        );
		$this->add_control(
			'pattern_image',
			...
			[
				...
				[
					...
					[
						...
						'default' => 'one',
						'options' => array(
							'one' => esc_html__( 'Choose Style Text Align Right', 'educamb' ),
    ...
    <!-- Start Main Slider -->
    <section class="main-slider main-slider--style10">
        <div class="slider-box">
            <?php if($settings['pattern_image']['id']) { ?>
            <div class="main-slider-style10-shape-bg" style="background-image:url(<?php echo esc_url(wp_get_attachment_url($settings['pattern_image']['id'])); ?>)"></div>
			<?php } ?>
            <!-- Banner Carousel -->
            <div class="banner-carousel owl-theme owl-carousel">
                ...
                <div class="slide">
                    ...
                    <div class="auto-container">
                        <div class="<?php if($item['style_two'] == 'two') echo 'content'; else echo 'content content--right'; ?>">
                            ...
                            <?php } ?>
                            <?php if($item['text'] || $item['btn_title']) { ?>
                            <div class="text">
