 ...
 * @since 1.0.0
 */
class Education_Instructors extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_education_instructors';
	}
	...
	public function get_title() {
		return esc_html__( 'Education Instructors', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'education_instructors',
			[
				'label' => esc_html__( 'Education Instructors', 'educamb' ),
			]
		);
		$this->add_control(
			'subtitle',
	...
	protected function render() {
        ...
        <!--Start Top Instructors Area-->
        <section class="top-instructors-area">
            <div class="container">
                
                <div class="row">
                    <div class="col-xl-12">
                        <div class="top-instructors__top-title">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="single-instructors-style1">
                            ...
                            <div class="img-holder">
                                <div class="inner">
                                    <?php the_post_thumbnail( 'educamb_270x270' );?>
                                </div>
