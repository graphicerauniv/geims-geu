 ...
 * @since 1.0.0
 */
class Quiz_Blog_List extends Widget_Base {
	...
	public function get_name() {
		return 'educamb_latest_quiz_blog_list';
	}
	...
	public function get_title() {
		return esc_html__( 'Quiz Blog List', 'educamb' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'quiz_blog_list',
			[
				'label' => esc_html__( 'Quiz Blog List', 'educamb' ),
			]
		);
		$this->add_control(
			'sidebar_slug',
    ...
    <!--Start Blog Page Two -->
    <section class="blog-page-two quizzes-blog-page-two">
        <div class="quizzes-blog-page-two-gray-bg"></div>
        <div class="container">
            <div class="row">
